...
#####
## Load, Train, Bench, Push, Clean script for Pythia 1.4B on (original) MiniPile
#####
...
## I ran with:
## CUDA_VISIBLE_DEVICES=0,1,2 torchrun --nproc_per_node=3 03_train_1.4B_minipile.py
## on 3x A100
...
dataset_target = "MiniPile"
dataset_cache = "MiniPile_Cache"
dataset_repo = "JeanKaddour/minipile"

output_folder = "pythia1.4b_minipile_trained"
log_folder = "1.4b_minipile_logs" # This is will remain empty

bench_txt = str(base_path / output_folder / "03_eval_1.4B_minipile.txt")
bench_table_txt = str(base_path / output_folder / "03_eval_1.4B_minipile_table.txt")
