...
class DistillConfig:
    ...
    edition: str = "DensityNano" # Version of MiniPile, distinguishes file naming + output directory
    ...
    train_count: int = 800_758
    val_count: int = 534
    test_count: int = 10_676 # Just correcting rounding errors: This produces 750000:500:10000
