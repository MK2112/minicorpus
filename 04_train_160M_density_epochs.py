...
def training():
    ...
    output_dir = str(base_path / "pythia160m_minipile_Density_Epoch_trained")
    log_dir = str(base_path / "160m_minipile_Density_Epoch_logs")
    ...
    training_args = TrainingArguments(
        ...
        warmup_steps=int(0.01 * 1366),   # 1% of total steps for warmup
        logging_dir=log_dir,
        logging_steps=10,
        eval_strategy="steps",
    ...
    trainer.save_model(str(base_path / "pythia160m_minipile_Density_Epoch_trained")) # This saves the model weights
...
# Reattach to tmux session: tmux attach -t 160m_minipile_density_epoch
# tmux list-sessions
# tmux kill-session -t 160m_minipile_density_epoch
